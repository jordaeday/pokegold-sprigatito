...
Rival1Group:
	...
	db 32, MEOWSCARADA,REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 38, MEOWSCARADA,REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
...
Rival2Group:
	...
	db 45, MEOWSCARADA,RAZOR_LEAF, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 50, MEOWSCARADA,GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
