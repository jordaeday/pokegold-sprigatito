...
; SPRITE_ANIM_OBJ_GS_INTRO_SPRIGATITO
	db SPRITE_ANIM_FRAMESET_GS_INTRO_SPRIGATITO,       SPRITE_ANIM_FUNC_GS_INTRO_SPRIGATITO_TOTODILE,SPRITE_ANIM_DICT_GS_INTRO_2
...
; SPRITE_ANIM_OBJ_GS_INTRO_TOTODILE
	db SPRITE_ANIM_FRAMESET_GS_INTRO_TOTODILE,         SPRITE_ANIM_FUNC_GS_INTRO_SPRIGATITO_TOTODILE,SPRITE_ANIM_DICT_GS_INTRO_2
