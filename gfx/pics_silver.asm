...
MeowscaradaFrontpic: INCBIN "gfx/pokemon/meowscarada/front_silver.2bpp.lz"
...
FloragatoFrontpic:   INCBIN "gfx/pokemon/floragato/front.2bpp.lz"
...
MeowscaradaBackpic:  INCBIN "gfx/pokemon/meowscarada/back.2bpp.lz"
...
SprigatitoFrontpic:  INCBIN "gfx/pokemon/sprigatito/front_silver.2bpp.lz"
