...
; SpriteAnimObjects indexes (see data/sprite_anims/objects.asm)
	...
	const SPRITE_ANIM_OBJ_GS_INTRO_SPRIGATITO       ; 0c
...
; DoSpriteAnimFrame.Jumptable indexes (see engine/sprite_anims/functions.asm)
	...
	const SPRITE_ANIM_FUNC_GS_INTRO_SPRIGATITO_TOTODILE; 0e
...
; SpriteAnimFrameData indexes (see data/sprite_anims/framesets.asm)
	...
	const SPRITE_ANIM_FRAMESET_GS_INTRO_SPRIGATITO       ; 13
...
; SpriteAnimOAMData indexes (see data/sprite_anims/oam.asm)
	...
	const SPRITE_ANIM_OAMSET_GS_INTRO_SPRIGATITO         ; 1b
