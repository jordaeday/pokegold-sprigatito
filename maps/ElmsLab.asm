...
SprigatitoPokeBallScript:
	...
	closepokepic
	opentext
	writetext TakeSprigatitoText
	yesorno
	iffalse DidntChooseStarterScript
	disappear ELMSLAB_POKE_BALL3
	setevent EVENT_GOT_SPRIGATITO_FROM_ELM
	writetext ChoseStarterText
	promptbutton
	waitsfx
	...
	closetext
	applymovement PLAYER, AfterSprigatitoMovement
	sjump ElmDirectionsScript
...
ElmsLab_MapEvents:
	...
	object_event  8,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SprigatitoPokeBallScript, EVENT_SPRIGATITO_POKEBALL_IN_ELMS_LAB
